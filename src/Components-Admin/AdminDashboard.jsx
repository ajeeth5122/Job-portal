            ...
            <div className='AdminContainer'>
                <div className='Admin-Sidebar'>
                    ...
                    <div className='Admin-Sidebar-list'>
                        ...
                        <div onClick={() => {setActiveTab("Job Monitoring"); setShowHighlightedJobs(false)}} className={activetab === "Job Monitoring" ? "Admin-Active" : 'Admin-Navbar'}>
                            <div className='Admin-Navbox'>
                        ...
                        <div onClick={() => { setActiveTab('Activity Monitoring'); setSubTab('AdminMonitor'); setShowHighlightedJobs(false) }} className={activetab === "Activity Monitoring" ? "Admin-Active" : 'Admin-Navbar'}>
                            <div className='Admin-Navbox'>
                        ...
                        <div onClick={() => { setActiveTab('User Management'), navigate('/Job-portal/admin/Dashboard'); setShowHighlightedJobs(false) }} className={activetab === "User Management" ? "Admin-Active" : 'Admin-Navbar'}>
                            <div className='Admin-Navbox'>
                        ...
                        <div onClick={() => {setActiveTab('SupportHub'), setShowHighlightedJobs(false)}} className={activetab === "SupportHub" ? "Admin-Active" : 'Admin-Navbar'}>
                            <div className='Admin-Navbox'>
                                                ...
                                                <div className="admin-dash-stats-row">
                                                    ...
                                                    <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                                        <img
                                                            ...
                                                            width={10}
                                                            alt={stat.isUp ? "Up" : "Down"}
                                                        />
                                                        <span
                                                            style={{
                                                                fontSize: "14px",
                                                                paddingLeft: "5px",
                                                                color: stat.isUp ? "#00C635" : "#F90C00"
                                                            }}
                                                        >
                                                            {stat.trend}
                                                        </span>
